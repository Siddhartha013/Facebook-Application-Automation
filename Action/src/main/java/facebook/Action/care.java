...
public class care {
	...
	public static void careMain(String url, String userName, String userPassword) {
	    ...
	    actions.click(driver.findElement(By.xpath("//div[@aria-label='Care']"))).perform();
	    System.out.println("Item has been Cared Successfully");
	    try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			e1.printStackTrace();
