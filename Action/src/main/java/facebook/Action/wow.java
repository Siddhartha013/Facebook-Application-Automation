...
public class wow {
	...
	public static void wowMain(String url, String userName, String userPassword) {
	    ...
	    actions.click(driver.findElement(By.xpath("//div[@aria-label='Wow']"))).perform();
	    System.out.println("Item has been Wow Successfully");
	    try {
			Thread.sleep(3000);
		} catch (InterruptedException e1) {
			e1.printStackTrace();
