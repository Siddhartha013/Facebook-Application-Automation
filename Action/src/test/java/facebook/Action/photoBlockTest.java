...
public class photoBlockTest {
	...
	public static void main(String[] args) {
		...
		driver.navigate().to("https://www.facebook.com/photo?fbid=302937317862217&set=pcb.302937617862187"); 
		driver.get("https://www.facebook.com/photo?fbid=302937317862217&set=pcb.302937617862187");
		try {
			Thread.sleep(3000);
